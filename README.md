...
[![Build Status](https://github.com/coccinella-labs/xnubuild/actions/workflows/build.yml/badge.svg)](https://github.com/coccinella-labs/xnubuild/actions/workflows/build.yml)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/coccinella-labs/xnubuild.git
   cd xnubuild
   ```
